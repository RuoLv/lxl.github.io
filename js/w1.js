!function ()
{
    ...
    function b()
    {
        ...
        {
            i.x += i.xa, i.y += i.ya, i.xa *= i.x > r || i.x < 0 ? -1 : 1, i.ya *= i.y > n || i.y < 0 ? -1 : 1, e.fillStyle= "#ED6E58",e.fillRect(i.x - 0.5, i.y - 0.5, 1, 1);
    ...
    u.id = c;
    u.style.cssText = "position:fixed;top:0;left:0;z-index:" + s.z + ";opacity:" + s.o; j("body")[0].appendChild(u); k(), window.onresize = k;
